    ...
    <main style={wrap}>
      <div style={inner}>
        ...
        {isSaga && t.compensations.length > 0 && (
          <>
            ...
            <p style={{ fontSize: 12, color: TEC_COLORS.subtext, margin: '0 0 10px', lineHeight: 1.5 }}>
              Run in reverse if a step fails — the saga leaves no partial state.
            </p>
        ...
        <p style={{ fontSize: 11, color: TEC_COLORS.subtext, margin: '22px 0 0', lineHeight: 1.5 }}>
          ...
          context through every step. It never runs the business rule inside
          a step, and never moves Pi outside tec-payment-service. Execution is the V1
